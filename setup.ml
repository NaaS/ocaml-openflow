...
(* OASIS_START *)
<<<<<<< HEAD
(* DO NOT EDIT (digest: 1498243a037d6438e67ecc8392c852a4) *)
=======
(* DO NOT EDIT (digest: ef8b9ab411e8404520ef9c9feba34fbe) *)
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "build things over the direct xen net";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "build programs with a depency on lwt.unix";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build xen applications";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
...
>>>>>>> 6df49db3cdbba5c9fff22b50b080c192ca0e1457
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Ofswitch"; "Ofswitch_config"; "Ofswitch_standalone"
                        ];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "openflow";
                      lib_findlib_name = Some "switch";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "switch_model";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Ofswitch_model"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "openflow";
                      lib_findlib_name = Some "switch_model";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                     cs_name = "ofcontroller_lwt";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "lwt_controller.ml"});
               Executable
                 ({
                     cs_name = "ofswitch_lwt";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "lwt_switch.ml"});
               Executable
                 ({
                     cs_name = "ofswitch";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "xen_switch.ml"});
               Executable
                 ({
                     cs_name = "ofcontroller";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "xen_controller.ml"})
            ];
          plugins =
     ...
     oasis_digest =
<<<<<<< HEAD
       Some "\216\150\138\176i\233\191\001p \003\232'\026\211\017";
=======
       Some "\206\226Mu\247\203\147\157\191\164\198\128\154}\244\236";
>>>>>>> 6df49db3cdbba5c9fff22b50b080c192ca0e1457
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
